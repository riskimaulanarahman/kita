...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="{{ url('/') }}" class="logo logo-dark">
            <span class="logo-sm">
                <b style="font-size: 22px;">K</b>
            </span>
            <span class="logo-lg">
                <b style="font-size: 30px;">KITA</b>
            </span>
        </a>
        ...
        <a href="{{ url('/') }}" class="logo logo-light">
            <span class="logo-lg">
                ...
                <b style="font-size: 30px; color:white !important;">SWALAYAN</b>
            </span>
            <span class="logo-sm">
                {{-- <img src="{{ URL::asset('assets/images/logo-light-sm.png') }}" alt="" height="22"> --}}
                <b style="font-size: 22px; color:white !important;">SK</b>
            </span>
        </a>
    </div>
